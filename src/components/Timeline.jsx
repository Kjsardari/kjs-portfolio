  ...
  return (
    <div className="c-space section-spacing" ref={containerRef}>
      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => {
          const isFreelancer = item.title.toLowerCase().includes("freelancer");
          ...
          return (
            ...
            >
              ...
              <div className="relative w-full pl-20 pr-4 md:pl-4">
                ...
                {isFreelancer && (
                  <a
                    href="https://drive.google.com/drive/u/0/folders/10BTx_TTGf5LLio3A3XSvDvu0SGVsvjY_" // 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-6 px-6 py-3 text-sm font-semibold text-white bg-purple-600 rounded-lg hover:bg-purple-700 transition duration-300"
                  >
                    🔗 Check Portfolio
                  </a>
                )}
